import { hasDocker, withEphemeralPostgres } from "@learn-fullstack/testing";
...
// Skip when no Docker daemon is reachable (CI always has one).
describe.skipIf(!hasDocker())(
  "Task 3 — Nest integration against ephemeral Postgres",
  () => {
