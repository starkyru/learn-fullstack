 ...
 *
 * EXT: this reference is provided complete (src mirrors solution). Read it, then extend it —
 * e.g. add a second hole, a POST handler, or a `Cache-Control` header — and grade against the tests.
 */
